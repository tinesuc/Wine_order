...
form_submit = (event, ell) => {
    ...
    for(i=0;i<5;i++){
        ...
        if(id=="email"){value="<span style='color:rgb(230,230,230);'>---</span>"}
    ...
    if(!(phn1.length==3&&phn2.length==3&&phn3.length==4)){
        if(!(phn1.length==0&&phn2.length==0&&phn3.length==0)){
            ...
            dest.innerHTML="<span style='color:rgb(230,230,230);'>---</span>"
        }
    }else{
    ...
    if(invalids.length!=0){
        ...
        Swal.fire({
            title: '<strong>Napeèni vnosi</strong>',
            icon: 'error',
    ...
    if(ordered.length==0){
        Swal.fire({
            title: '<strong>Ni naroèila</strong>',
            icon: 'error',
    ...
    for(i=0;i<ordered.length;i++){
        ...
        text+="<tr style='width:100%;'>" +
            "   <td class='s_name' colspan='2' style='text-align:left;'>"+item.name+"</td>"+
            "   <td class='s_amount' style='width:33%; text-align:right;'>kos "+item.amount+"</td>"+
            "</tr>"+
            "<tr style='width:100%;'>"+
            "   <td class='s_tax' style='width:33%; text-align:right;'>"+(item.tax*100).toFixed(2)+"%</td>"+
            "   <td class='s_price' style='width:33%; text-align:right;'>"+(item.price).toFixed(2)+"</td>"+
            "   <td class='s_cost' style='width:33%; text-align:right;'>"+item.cost.toFixed(2)+"</td>"+
            "</tr>";
    }
